...
# 2 - 1 == 0  0.26060    0.05704   4.568  3.1e-05 ***
...
* Cours de Sciences des données II à Mons : <https://classroom.github.com/a/mXAIu4Ir>

* Pour les autres utilisateurs de ce livre, veuillez faire un "fork" du dépôt [
ovocytes
](https://github.com/BioDataScience-Course/ovocytes). Si vous souhaitez accéder à une version précédente particulière de l'exercice, sélectionnez la release correspondante à l'année que vous recherchez.  
...
* Cours de Sciences des données II à Mons : <https://classroom.github.com/a/hS069etL>

* Pour les autres utilisateurs de ce livre, veuillez faire un "fork" du dépôt [
human
](https://github.com/BioDataScience-Course/human). Si vous souhaitez accéder à une version précédente particulière de l'exercice, sélectionnez la release correspondante à l'année que vous recherchez.  
